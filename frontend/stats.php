    ...
    <div id="vue-app">
      ...
      <nav class="container_fluid tab_container">
        <ul class="nav nav-tabs container" role=tablist>
          <li class="nav-item">
            <a class="nav-link" 
              :class="{'active':active_tab == 'popular_articles'}" 
              href="#popular_articles" 
              role="tab" 
              @click="active_tab = 'popular_articles'">
              Popular Articles
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" 
              :class="{'active':active_tab == 'influential_users'}" 
              href="#influential_users" 
              role="tab" 
              @click="active_tab = 'influential_users'">
              Influential Accounts
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" 
              :class="{'active':active_tab == 'active_users'}" 
              href="#active_users" 
              role="tab" 
              @click="active_tab = 'active_users'">
              Active Accounts
            </a>
          </li>
        </ul>
      ...
      <div class="tab-content">
        <section class="tab-pane active container-fluid" v-if="active_tab=='popular_articles'" role="tabpanel">
          <div class="row">
