...
-->
	...
	<p class="m-0 text-center mb-1">Share</p>
			...
			<div class="d-block p-2 text-center d-md-flex flex-column justify-content-center align-items-center">
				<button class="btn btn-primary ml-1 mr-1" style="z-index: 0; font-size: .75rem" type="button" @click='createAsCSV()' data-toggle="tooltip" @mouseOver="hoverTooltip" @mouseOut="hideTooltip"  :disabled="failed_to_get_network" title="download data as a CSV file" v-if="not_imported">Export - CSV</button>
			</div>
			<div class="d-block p-2 text-center d-md-flex flex-column justify-content-center align-items-center">
				<button class="btn btn-primary ml-1 mr-1" style="z-index: 0; font-size: .75rem" type="button" @click='createAsJSON()' data-toggle="tooltip" @mouseOver="hoverTooltip" @mouseOut="hideTooltip"  :disabled="failed_to_get_network" title="download data as a JSON file" v-if="not_imported">Export - JSON</button>
			</div>
