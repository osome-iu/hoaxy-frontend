...
var app = new Vue({
    ...
    computed: {
        ...
        embeddedWidgetCode: function () {
          // return "<div style=\"border:solid;border-width:thin;border-color:gray;border-radius:10px;width:510px;height:250px;\"><div style=\"float:left;padding:3px;width:250;height:250px;display:inline-block;\"><div style=\"text-align:center;vertical-align:middle;color:blue;font-size:40px;font-weight:bold;\">HOAXY</br></br></div><div>Use Hoaxy to see how this spreads online: <a href=\"" + location.href + "\" target=\"_blank\">" + this.shortenArticleText(this.searched_query_text) + "</div></div><div style=\"float:right;width:250;height:250px;display:inline-block;border-left:1px solid gray;\"><img style=\"width:240;height:240px;padding:3px;\" src=\"" + this.widgetScreenshotDataUrl + "\"></img></div></div>"

					return "<div style=\"box-sizing:border-box;color:black;background-color:white;border:solid;border-width:thin;border-color:gray;border-radius:10px;width:300px;height:150px;\"><div style=\"box-sizing:inherit;float:left;width:150px;height:150px;display:inline-block;margin-right:0px;\"><div style=\"box-sizing:inherit;text-align:center;vertical-align:middle;color:blue;font-size:25px;font-weight:bold;height:70px;border-bottom:1px solid gray;padding-top:15px;padding-bottom:15px\">HOAXY</div><div style=\"word-break:break-all;box-sizing:inherit;height:80px;padding:5px;font-size:10px\">Use Hoaxy to see how this spreads online: <a href=\"" + location.href + "\" target=\"_blank\">" + this.shortenArticleText(this.searched_query_text) + "</div></div><div style=\"margin-left:0px;float:left;width:145px;height:150px;display:inline-block;border-left:1px solid gray;\"><img style=\"box-sizing:inherit;width:140px;height:140px;padding-top:5px;padding-bottom:5px;padding-right:5px;\" src=\"" + this.widgetScreenshotDataUrl + "\"></img></div></div>"
        },
