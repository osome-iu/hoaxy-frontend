...
var app = new Vue({
    ...
    computed: {
        ...
        embeddedWidgetCode: function () {
          ...
          return "<div style=\"border:solid;border-width:thin;border-color:gray;border-radius:10px;width:510px;height:250px;\"><div style=\"padding:3px;width:250;height:250px;display:inline-block;\"><div style=\"text-align:center;vertical-align:middle;color:blue;font-size:40px;font-weight:bold;\">HOAXY</br></br></div><div>Use Hoaxy to see how this spreads online: <a href=\"" + location.href + "\" target=\"_blank\">" + this.shortenArticleText(this.searched_query_text) + "</div></div><div style=\"width:250;height:250px;display:inline-block;border-left:1px solid gray;\"><img style=\"width:240;height:240px;padding:3px;\" src=\"" + this.widgetScreenshotDataUrl + "\"></img></div></div>"
        },
