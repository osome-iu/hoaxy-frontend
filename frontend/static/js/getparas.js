...
function changeURLParams(){
	console.debug("Legacy changURLParams called. Use app.changeURLParams instead.");
	app.changeURLParams();
	//
	// var query = app.query_text;
	// var sort = app.query_sort;
	//
...
function loadURLParams(){
	console.debug("Legacy loadURLParams called. Functionality now takes place in the Vue app mounted hook.")
	...
	// }
	//
	// app.query_text = params_object.query || app.query_text;
	// app.query_sort = params_object.sort || app.query_sort;
	//
	// if(params_object.query)
	// {
	// 	dontScroll = true;
